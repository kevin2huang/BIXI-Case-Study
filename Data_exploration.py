...
df_numerical = all_BIXI_data[['Month', 'Hour', 'is_Weekend', 'Temp_Bin', 'Hum_Bin', 'duration_sec', 'Wind_spd', 'Demand']]

# split into categorical values
df_categorical = all_BIXI_data[['start_station_code']]
